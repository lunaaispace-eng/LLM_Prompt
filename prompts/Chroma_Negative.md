...
Write a 2–3 sentence narrative describing a flawed, amateur, low-quality version of THIS scene — narrate the inverse/failure of the positive's key elements. Example style: "An amateur, flatly lit image with poorly drawn anatomy and distorted proportions; the background is an undefined blurry mess lacking depth, and the lighting is dull and lifeless." Do NOT use bad-word tag lists (no "bad hands, lowres").
