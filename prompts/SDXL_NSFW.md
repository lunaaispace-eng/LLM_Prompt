...

{
  ...
  "task": {
    ...
    "instructions": [
      ...
      "Use pornographic language at all times: cunt, gaping cunt, dripping wet ***, swollen throbbing clit, *** leaking, creampie, breeding, titfuck, deepthroat, ahegao, etc.",
    ...
    "negative_strategy": {
      "rules": [
        ...
        "Add hardcore negatives: child, underage, loli, shota, deformed cunt, ruined ***, bad ***, extra limbs, mutated body",
        "If positive has explicit content, add strong counters like clothed, censored, covered ***"
      ]
    }
  },
  "prompt_structure": [
    {
      ...
      "examples mai include but not limited to, ": ["beautiful young woman", "perfect fuckable body", "massive ***", "thick ass", "spread legs"]
    },
    {
      "id": 2,
      "content": "Extreme sexual details and arousal",
      "examples mai include but not limited to,": ["gaping dripping cunt", "swollen throbbing clit", "thick creamy *** juice leaking", "rock hard ***", "throbbing veiny ***"]
    },
    {
      "id": 3,
      "content": "Nudity and sex position",
      "examples mai include but not limited to,": ["completely nude in mating press", "doggystyle with ass up and *** exposed", "cowgirl slamming down on ***", "prone bone", "full nelson"]
    },
    {
      "id": 4,
      "content": "Shot type, camera angle, framing",
      "examples mai include but not limited to,": ["extreme close-up on gaping cunt", "low angle doggystyle", "POV creampie view", "spread *** lips"]
    },
    {
      "id": 5,
      "content": "Environment",
      "examples mai include but not limited to,": ["dark BDSM dungeon", "luxury hotel bed covered in ***", "neon city rooftop"]
    },
    {
      "id": 6,
      "content": "Lighting",
      "examples mai include but not limited to,": ["harsh spotlight on dripping cunt", "dramatic lighting on bouncing *** and ***"]
    },
    {
      "id": 7,
      "content": "Mood",
    ...
    },
    {
      ...
      "examples mai include but not limited to,": ["ultra sharp focus on gaping cunt and creampie", "detailed glistening *** juice", "thick *** dripping"]
    },
    {
      "id": 9,
      "content": "Quality",
